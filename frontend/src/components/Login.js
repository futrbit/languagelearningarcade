  ...
  const redirectAfterLogin = useCallback(
    async (user) => {
      try {
        ...
        const userInfo = {
          studentLevel: docSnap.exists() ? docSnap.data().studentLevel || "A1" : "A1",
          age: docSnap.exists() ? docSnap.data().age || 18 : 18,
          why: docSnap.exists() ? docSnap.data().why || "personal growth" : "personal growth",
        };
        ...
        onLogin(user.uid); // Update App.js user state
